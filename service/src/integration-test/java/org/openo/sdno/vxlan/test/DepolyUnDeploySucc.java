...
public class DepolyUnDeploySucc extends TestManager {
    ...
    private static final String DEPLOY_VXLAN = "src/integration-test/resources/testcase/deployvxlansuccess.json";

    private static final String UNDEPLOY_VXLAN = "src/integration-test/resources/testcase/undeployvxlansuccess.json";
    ...
    public void CreateVxlanSuccessTest1() throws ServiceException {
        ...
        HttpRquestResponse unDeployHttpObject = HttpModelUtils.praseHttpRquestResponseFromFile(UNDEPLOY_VXLAN);
        HttpRequest unDployRequest = unDeployHttpObject.getRequest();
        execTestCase(unDployRequest, new SuccessChecker());
        System.out.println("undeploy finished, start to deploy.");
        HttpRquestResponse deployHttpObjectBatch = HttpModelUtils.praseHttpRquestResponseFromFile(DEPLOY_VXLAN);
        HttpRequest deployRequestBatch = deployHttpObjectBatch.getRequest();
        execTestCase(deployRequestBatch, new SuccessChecker());
        System.out.println("deploy finished, start to delete.");
        ...
        System.out.println("delete finished, bye.");
    }
