...
public class CreateSbiVxlanResponseHandler extends MocoResponseHandler {
    ...
    public void processRequestandResponse(HttpRquestResponse httpObject) {
        ...
        List<SbiNeVxlanInstance> inputInstanceList =
                JsonUtil.fromJson(httpRequest.getData(), new TypeReference<List<SbiNeVxlanInstance>>() {});
        ResultRsp<List<SbiNeVxlanInstance>> newResult =
                new ResultRsp<List<SbiNeVxlanInstance>>(ErrorCode.OVERLAYVPN_SUCCESS);
