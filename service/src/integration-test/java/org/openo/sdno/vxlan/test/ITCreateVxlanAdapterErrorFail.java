...
import org.openo.sdno.vxlan.checker.FailChecker;
import org.openo.sdno.vxlan.checker.SuccessChecker;
import org.openo.sdno.vxlan.mocoserver.SbiAdapterFailServer;

public class ITCreateVxlanAdapterErrorFail extends TestManager {

    private SbiAdapterFailServer sbiAdapterServer = new SbiAdapterFailServer();
    ...
    @Test
    public void CreateVxlanFailTest() throws ServiceException {
